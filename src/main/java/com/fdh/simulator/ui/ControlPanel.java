...
public class ControlPanel extends JFrame implements ActionListener {
    ...
    // private String ip = "192.168.1.98";
    private String ip = "192.168.0.101";
    private String port = "8088";
    // private String port = "8082";
    private String simulatorID = "101";
    private String heartbeat = "60";
    private String testingTime = "120";
    /**
     * 多选列表
     */
    private JList jList;
    ...
    public void init(){
        ...
        String ip = PropertiesUtils.getProperty("serverip");
        String port = PropertiesUtils.getProperty("serverport");
        if (StringUtil.isNullOrEmpty(ip) || StringUtil.isNullOrEmpty(port)) {
            logger.error("ip或者端口为null");
        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Connect")) {
            if (!simulator.isIsconnected()) {
                // 设置心跳时间
                simulator.setHeartBeat(Integer.valueOf(tfHeatBeat.getText()));
                //开始连接
                simulator.connect(tfIPAdress.getText(), Integer.parseInt(tfPort.getText()));
                new Timer().schedule(new ScheduleTask(), 0, 5000);
